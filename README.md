...
おはこんばんちわございません、パソコン技術部です。このWebサイトは、元部員が勝手に作った自己満Webサイトです（現在は引退済み）。Webデザインとか全くやったことなかったんですが、なんかノリと勢いだけでできました。

Hello there. Hi, we're the PC Tech Department. This website is a self-indulgent site made by a former member (now retired).
I'd never done web design before, but somehow I pulled it off just on momentum and enthusiasm.
